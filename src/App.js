        ...
        <img id='img-latwo' src={img_latwo}/>
            <div id="main-container">
                <div className="container" >
                    <div id='detail-1' className="our-details-div right-detail">
                    ...
                    <div id='img-1-div' className="image-div">
                        {/* <div id='img-span'></div> */}
                      <img id="img-1" className="img right-img" src={img_1}/>
                    </div>
                </div>

                <div className="container" >
                    <div id='img-2-div' className="image-div">
                        <img id="img-2" className="img left-img" src={img_2}/>
                    </div>
                    <div id='detail-2' className="our-details-div left-detail">
                ...
                <div className="container" >
                    <div id='detail-3' className="our-details-div right-detail">
                    ...
                    <div id='img-3-div' className="image-div">
                        <img id="img-3" className="img right-img" src={img_3}/>
                    </div>
                </div>

                <div className="container" >
                    <div id='img-4-div' className="image-div">
                        <img id="img-4" className="img left-img" src={img_4}/>
                    </div>
                    <div id='detail-4' className="our-details-div left-detail">
                ...
                <div className="container" >
                    <div id='detail-5' className="our-details-div right-detail">
                    ...
                    <div id='img-5-div' className="image-div">
                        <img id="img-5" className="img right-img" src={img_5}/>
                    </div>
                </div>

                <div className="container" >
                    <div id='img-6-div' className="image-div">
                        <img id="img-6" className="img left-img" src={img_6}/>
                    </div>
                    <div id='detail-6' className="our-details-div left-detail">
                ...
                <div className="container"  >
                    <div id='detail-7' className="our-details-div right-detail">
                    ...
                    <div id='img-7-div' className="image-div">
                        <img id="img-7" className="img right-img" src={img_7}/>
                    </div>
                </div>
            </div>
            <Details/>
